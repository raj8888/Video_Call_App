export const getIncomingCallBox = (connection_type,acceptCall,rejectCall) =>{
    ...
    img.setAttribute("src","../Images/dialogAvatar.png")
    ...
    acceptCallImg.setAttribute("src","../Images/acceptCall.png")
    ...
    rejectCallImg.setAttribute("src","../Images/rejectCall.png")
    ...
    export const getCallingDialog=(rejectCallHandler)=>{
        ...
        dropCallImg.setAttribute("src","../Images/rejectCall.png")
